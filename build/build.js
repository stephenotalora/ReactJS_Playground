...
/***/ function(module, exports, __webpack_require__) {
	...
	var StyleSheet = __webpack_require__(83);
	var mountTarget = document.getElementById('mount-point');


	var CountComp = React.createClass({displayName: "CountComp",
	    render: function() {
	        return (
	...
	var TestComponent = React.createClass({displayName: "TestComponent",
	    ...
	    render: function() {
	        return (
	           React.createElement("div", {className: "nameComp", style: StyleSheet.nameComp}, 
	               React.createElement("h1", null, this.props.name), 
	               React.createElement(CountComp, {count: this.state.count}), 
	               React.createElement("div", {style: StyleSheet.btn_container}, 
	                   React.createElement("button", {type: "button", style: StyleSheet.btn, onClick: this.incrementCount}, "Incement")
	               ), 
	               React.createElement(TextEntryTag, null)
	           )
	        );
	    },
	...
	var TextEntryTag = React.createClass({displayName: "TextEntryTag",
	    getInitialState: function() {
	        return {text: ''}
	    },
	    ...
	    render: function() {
	        return (
	           React.createElement("div", {className: "myComp"}, 
	               React.createElement("div", {className: "holder"}, React.createElement("p", null, "Cool value is: ", this.state.text)), 
	               React.createElement("label", {htmlFor: "entry"}, "JSX Entry"), 
	               React.createElement("input", {id: "entry", type: "text", onChange: this.onChange}), 
	               React.createElement("button", {type: "button", style: StyleSheet.btn, onClick: this.onClick}, "alert")
	           )
	        );
	    }
	});
	...
	React.render(
	    React.createElement(TestComponent, {name: "Counter App"}),
	    mountTarget
	);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ReactElementExtended            = __webpack_require__(6);
	var ReactCompositeComponentExtended = __webpack_require__(7);
	var ExecutionEnvironment            = __webpack_require__(8);

	var applyMediaQueries               = __webpack_require__(9);
	var generateUniqueCSSClassName      = __webpack_require__(10);
	var stylesToCSS                     = __webpack_require__(11);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var assign                 = __webpack_require__(5);
	var recalcMediaQueryStyles = __webpack_require__(34);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var isUnitlessNumber = __webpack_require__(37).isUnitlessNumber;
	var hyphenateStyleName = __webpack_require__(38);
	var isArray = Array.isArray;
	var keys = Object.keys;
	var unsupportedPseudoClasses = __webpack_require__(39);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ReactDOMForm = __webpack_require__(1);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var getReactRootElementInContainer = __webpack_require__(62);
...
/***/ function(module, exports, __webpack_require__) {
	...
	try {
	  // React 0.13
	  enqueueForceUpdate = __webpack_require__(40).enqueueForceUpdate;
	  ReactUpdates = __webpack_require__(60);

	} catch(e) {
	  // React 0.12
	  enqueueForceUpdate = __webpack_require__(60).enqueueUpdate;
	}
	var matchMedia = null;
	if (typeof window !== 'undefined' && !window.__ReactStyle__) {
	  matchMedia = window.matchMedia;
